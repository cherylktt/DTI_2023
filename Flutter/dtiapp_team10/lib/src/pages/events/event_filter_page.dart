...
class EventsFilterPage extends StatefulWidget {
  const EventsFilterPage({Key ? key, required this.eventTag}) : super(key: key);
  final String eventTag;

  @override
  _EventsFilterPage createState() => _EventsFilterPage();
}

class _EventsFilterPage extends State<EventsFilterPage> {
  ...
  Widget _eventInformation(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      stream: FirebaseFirestore.instance.collection('eventInfo').where("eventTag", isEqualTo: widget.eventTag).snapshots(),
